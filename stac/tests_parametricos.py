...
def anova_test(matriz_datos, alpha=0.05):
	...
	Returns:
		...
		References:
			1. http://www.icicm.com/files/AN_LISIS_DE_VARIANZA.doc
			2. Contraste sobre la igualdad de medias en dos o más poblaciones normales, 
			   Manuel Oviedo - Beatriz Pateiro.
			3. http://biplot.usal.es/problemas/anova/ANOVA.html
    """
...
def bonferroni_test(nombres_algoritmos, medias_algoritmos, cuadrado_medio_error, N, alpha=0.05):
	...
	Returns:
		...
		References:
			1. Contraste sobre la igualdad de medias en dos o más poblaciones normales, 
			   Manuel Oviedo - Beatriz Pateiro.
	"""
